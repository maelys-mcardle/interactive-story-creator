...
const html = {
    ...
    allHistoryLinks: "#history-container .list-group",
    lastHistoryLinks: "#history-container .list-group:last-child",
    ...
    publishInputStoryCodeUrlCheckingIcon: "#input-story-code-url-checking-icon",
    publishInputStoryCodeUrlOkIcon: "#input-story-code-url-ok-icon",
    publishInputStoryCodeUrlFailIcon: "#input-story-code-url-fail-icon",
